<div class="stages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('state_credit'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($stage['User']['name'], array('controller' => 'users', 'action' => 'view', $stage['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($stage['Credit']['id'], array('controller' => 'credits', 'action' => 'view', $stage['Credit']['id'])); ?>
		</td>
		<td><?php echo h($stage['Stage']['state_credit']); ?>&nbsp;</td>
		<td><?php echo h($stage['Stage']['descrption']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $stage['Stage']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $stage['Stage']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
