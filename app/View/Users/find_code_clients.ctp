    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content cuadro_foto">
			<div class="modal-header">
				...
				<button type="button" id="btn_cerrar_camaraCD" class="close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body resultTomarFoto">
 				<select class="form-control" name="listaDeDispositivosCD" id="listaDeDispositivosCD"></select>
    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content cuadro_foto">
			<div class="modal-header">
				...
				<button type="button" id="btn_cerrar_camaraCT" class="close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body resultTomarFoto">
				<select class="form-control" name="listaDeDispositivosCT" id="listaDeDispositivosCT"></select>
    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content cuadro_foto">
			<div class="modal-header">
				...
				<button type="button" id="btn_cerrar_camaraFP" class="close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body resultTomarFoto">
				<select class="form-control" name="listaDeDispositivosFP" id="listaDeDispositivosFP"></select>
