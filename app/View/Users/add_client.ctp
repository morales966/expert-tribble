<div class="content-wrapper">
  	<div class="container-fluid cuadro_panding">
  		<div class="bg-white-content">
			<h2 class="tittle">Registro de Comercio</h2>
			<div class="form-group">
				<?php echo $this->Html->link("Atras", array('controller' => 'Users','action'=> 'comercios'), array( 'class' => 'btn btn-success pull-right')) ?>
	        </div>
			<?php echo $this->Form->create('User',array('id' => 'formAddCliemt','data-parsley-validate','enctype'=>"multipart/form-data")); ?>
				<div class="row">
			        ...
			        <div class="col-md-12 form-group">
	        			<?php echo $this->Form->button('Guardar',array("class" => "btn btn-success pull-right mb-3")); ?>
			        </div>
			    </div>
			</form>
		</div>
