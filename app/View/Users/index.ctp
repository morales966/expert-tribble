<div class="content-wrapper">
	<div class="container-fluid cuadro_panding">
		...
		<div class="bg-white-content mb-5">
			<h2 class="tittle">Usuarios del sistema</h2>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<?php endif ?>
							<td class="actions">
								<a  href="<?php echo $this->Html->url(array('action' => 'view', $user['User']['id'],'u')) ?>" data-toggle="tooltip" data-placement="top" title="Ver usuario">
